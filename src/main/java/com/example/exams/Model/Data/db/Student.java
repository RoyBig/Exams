...
public class Student extends User{
    ...
    public Student(Integer studentId, String firstname, String lastname, String login, String password, Email email) {
        super(studentId, firstname, lastname, login, password, email);
    }
}