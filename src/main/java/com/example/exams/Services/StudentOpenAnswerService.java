...
public class StudentOpenAnswerService {
    ...
    @Autowired
    public StudentOpenAnswerService(StudentopenanswerRepository studentopenanswerRepository,
    ...
    @Transactional
    public void deleteAllAnswersByQuestionId(String openQuestionId) {
        OpenQuestion openQuestion = openQuestionRepository.findById(openQuestionId)
                .orElseThrow(() -> new RuntimeException("OpenQuestion not found with id: " + openQuestionId));
